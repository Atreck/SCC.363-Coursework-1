...
/**
 * A simple utility aiding the creation of signature which can be used later for
 * verifying the users by a server and vice-versa.
 *
 */
...
public class SignUtil {
    ...
    // * @param algo an algorithm which the keys are based on (DSA/RSA, in this case
    // DSA)
    ...
    //
    // // Generate keys from their corresponding Strings based on the algorithm they
    // were created with
    // KeyPair pair = new KeyPair(getPublicKey(pubKey, algo), getPrivateKey(privKey,
    // algo));
    //
    // return pair;
    // }
     ...
     */
    public static String signChallenge(String challenge, PrivateKey privKey) throws NoSuchAlgorithmException,
    ...
    /**
     * Verifies whether a challenge signed by the party to which the challenge was
     * sent corresponds to the challenge sent by a verification party.
     * 
